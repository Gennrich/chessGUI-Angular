...
let turm_black = {
    x: 25,
    y: 25,
    src: 'assets/images/turm_black2.png'
};

let pferd_black = {
    x: 125,
    y: 25,
    src: 'assets/images/pferd_black2.png'
};

let laeufer_black = {
    x: 225,
    y: 25,
    src: 'assets/images/laeufer_black2.png'
};

let dame_black = {
    x: 325,
    y: 25,
    src: 'assets/images/dame_black2.png'
};

let koenig_black = {
    x: 425,
    y: 25,
    src: 'assets/images/koenig_black2.png'
};

let bauer_black = {
    x: 25,
    y: 125,
    src: 'assets/images/bauer_black2.png'
};
...
let turm_weiss = {
    x: 25,
    y: 725,
    src: 'assets/images/turm_weiss2.png'
};

let pferd_weiss = {
    x: 125,
    y: 725,
    src: 'assets/images/pferd_weiss2.png'
};

let laeufer_weiss = {
    x: 225,
    y: 725,
    src: 'assets/images/laeufer_weiss2.png'
};

let dame_weiss = {
    x: 325,
    y: 725,
    src: 'assets/images/dame_weiss2.png'
};

let koenig_weiss = {
    x: 425,
    y: 725,
    src: 'assets/images/koenig_weiss2.png'
};

let bauer_weiss = {
    x: 25,
    y: 625,
    src: 'assets/images/bauer_weiss2.png'
};
...
function loadImages() {
    backgroundImage.src = 'assets/images/chessFieldWithRand.png';
    backgroundImageRotated.src = 'assets/images/chessFieldRotated.png';
